...
public class CrestCapeLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public void render(PoseStack ps,
        ...
        ps.pushPose();
        // Vanilla-like cape spacing:
        // - No chest armor: cape sits closer to the back
        // - With chest armor: push the cape outward to prevent clipping into armor thickness
        float zOffset = chest.isEmpty() ? (3.0F / 16.0F) : (4.6F / 16.0F);
        ps.translate(0.0F, 0.0F, zOffset);
